 ...
 */
(function () {
  var cfg = window.EDEN_REVIEW_CONFIG || {};
  ...
  // Resolve sibling assets relative to THIS script's URL, not the page URL, so the
  // widget works from any page depth (hub root and multi-depth website pages alike).
  ...
  var js = document.createElement('script'); js.src = base + 'review-mode.js';
